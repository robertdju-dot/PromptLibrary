          ...
          <TableBody>
            {filteredPrompts.map((prompt) => (
              <TableRow key={prompt.id}>
                ...
                <TableCell className="font-mono text-xs text-muted-foreground">{prompt.userId}</TableCell>
                <TableCell>
                ...
                <TableCell className="text-right flex justify-end gap-2">
                  <Button variant="ghost" size="icon" className="w-8 h-8" onClick={() => handleView(prompt)}>
                    <Eye className="w-4 h-4" />
                  </Button>
                  <Button variant="ghost" size="icon" className="w-8 h-8 text-destructive hover:text-destructive hover:bg-destructive/10" onClick={() => handleDelete(prompt.id)}>
